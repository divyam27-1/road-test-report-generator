...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget = new QWidget(basic_info);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(0, 10, 258, 691));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        dateEdit->setDisplayFormat(QCoreApplication::translate("MainWindow", "dd/mm/yy", nullptr));

...
#include "../road_test_report_generator/entry.h"
...
static constexpr auto qt_meta_stringdata_CLASSentryENDCLASS = QtMocHelpers::stringData(
    "entry"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSentryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSentryENDCLASS_t qt_meta_stringdata_CLASSentryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 5)   // "entry"
    },
    "entry"
};
